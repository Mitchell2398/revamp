 ...
 * @returns true if update succeeded, false otherwise
 */
export declare function setAgentModel(model: string, options?: SourceWriteOptions): boolean;
/**
 ...
 */
export declare function removeAgentConfigProperty(propertyName: string, options?: SourceWriteOptions): boolean;
/**
 ...
 */
export declare function removeAgentModel(options?: SourceWriteOptions): boolean;
