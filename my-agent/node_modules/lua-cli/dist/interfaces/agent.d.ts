...
export interface UpdateAgentRequest {
    ...
    /** Governance SDK config. Passing null removes governance. The API-mode bearer token is resolved on the platform from GOVERNANCE_API_KEY, never sent here. */
    governance?: GovernanceConfig | null;
}
/**
 * An approved LLM model available for agent use.
 * Retrieved from GET /agents/self-serve/models.
 * The `code` field (e.g. 'openai/gpt-4o') is the value used as LuaAgent.model.
 */
...
export interface CreateAgentRequest {
    ...
    promoCode?: string;
    /** LLM model code (e.g. 'openai/gpt-4o'). When provided, set at creation time — avoids a separate PATCH call. */
    model?: string;
}
/**
