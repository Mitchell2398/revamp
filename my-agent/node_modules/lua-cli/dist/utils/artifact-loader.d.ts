 ...
 */
export declare function getFirstPrimitiveByKind<T extends ManifestPrimitive>(kind: PrimitiveKind, projectPath?: string): T | null;
...
export declare function getAgentModel(projectPath?: string): string | null;
export declare function getAgentGovernance(projectPath?: string): ManifestAgent['governance'] | null;
/**
