...
export function getAgentGovernance(projectPath = process.cwd()) {
    return getFirstPrimitiveByKind(PrimitiveKind.AGENT, projectPath)?.governance ?? null;
}
// =============================================================================
// BATCH LOADING
// =============================================================================
