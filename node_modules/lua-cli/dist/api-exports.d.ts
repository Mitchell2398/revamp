...
export interface AgentsApi {
     ...
     * ```
     */
    invoke(targetAgentId: string, input: import("@lua/shared-types").AgentInvocationInput): Promise<import("@lua/shared-types").AgentInvocationOutput>;
}
 ...
 * ```
 */
export declare function defineDevice(config: LuaDeviceConfig): LuaDevice;
/**
...
PostProcessorConfig, PostProcessorResponse, LuaAgent, LuaAgentConfig, LuaAgentModel, LuaMCPServer, LuaMCPServerConfig, MCPSSEServerConfig, MCPStreamableHttpServerConfig, MCPTransport, MCPServerBaseConfig, LuaDevice, LuaDeviceConfig, DeviceCommandConfig, DeviceTriggerConfig, LuaDeviceTrigger, LuaDeviceTriggerConfig, BasketStatus, OrderStatus, env };
