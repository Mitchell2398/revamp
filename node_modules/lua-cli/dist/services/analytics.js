 ...
 */
export async function enrichAnalyticsContext() {
    if (isTelemetryDisabled())
        return;
    try {
        let apiKey = null;
        ...
        catch { /* no key — enrich without identity */ }
        if (apiKey) {
